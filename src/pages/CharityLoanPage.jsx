...
import { Shield, Heart, CheckCircle, ArrowRight, Users, TrendingUp, HandHeart } from 'lucide-react';

export default function CharityLoanPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center rounded-full px-3 py-1 mb-4 sm:mb-6 border border-white/20 text-xs sm:text-sm" style={{
              ...
              <Heart className="w-3 h-3 sm:w-4 sm:h-4 text-purple-300 mr-2" />
            ...
            <p className="text-sm sm:text-lg lg:text-xl text-blue-100 leading-relaxed">
              Supporting organisations that make a difference. Flexible lending for charities and social enterprises.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
                Funding for those who help others
              </h2>
              <p className="text-gray-600 mb-6 text-sm sm:text-base leading-relaxed">
                Our Charity Loan is specifically designed for registered charities and social enterprises. We understand the unique challenges faced by non-profit organisations and offer flexible terms to support your mission.
              </p>
              <div className="space-y-3 mb-8">
                {[
                  "Preferential rates for registered charities",
                  "Flexible security arrangements",
                  "Repayment holidays available",
                  "No arrangement fees for small loans",
                  "Understanding of restricted funding"
                ].map((item, i) => (
              ...
              <Link to="/register" className="inline-flex items-center bg-[#1e3a8a] text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold hover:bg-blue-900 transition text-sm sm:text-base">
                Apply for Charity Loan <ArrowRight className="w-4 h-4 ml-2" />
              </Link>
            </div>
