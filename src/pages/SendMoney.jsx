...
export default function SendMoney() {
  ...
  const recentRecipients = useMemo(() => [
    ...
    { id: 3, name: 'Emma Thompson', handle: '@emmat', avatar: 'ET', color: 'bg-purple-500', type: 'personal' },
    { id: 4, name: 'Michael Brown', handle: '@mbrown', avatar: 'MB', color: 'bg-orange-500', type: 'personal' },
    { id: 5, name: 'Olivia Davis', handle: '@oliviad', avatar: 'OD', color: 'bg-teal-500', type: 'personal' },
    { id: 6, name: 'William Garcia', handle: '@wgarcia', avatar: 'WG', color: 'bg-indigo-500', type: 'personal' },
    { id: 7, name: 'Sophia Martinez', handle: '@smartinez', avatar: 'SM', color: 'bg-rose-500', type: 'personal' },
    { id: 8, name: 'Benjamin Anderson', handle: '@banderson', avatar: 'BA', color: 'bg-cyan-500', type: 'personal' },
    { id: 9, name: 'Isabella Taylor', handle: '@itaylor', avatar: 'IT', color: 'bg-violet-500', type: 'personal' },
    { id: 10, name: 'Lucas Thomas', handle: '@lthomas', avatar: 'LT', color: 'bg-amber-500', type: 'personal' },
    { id: 11, name: 'Mia Jackson', handle: '@mjackson', avatar: 'MJ', color: 'bg-lime-500', type: 'personal' },
    { id: 12, name: 'Henry White', handle: '@hwhite', avatar: 'HW', color: 'bg-sky-500', type: 'personal' },
    { id: 13, name: 'Charlotte Harris', handle: '@charris', avatar: 'CH', color: 'bg-fuchsia-500', type: 'personal' },
    { id: 14, name: 'Alexander Clark', handle: '@aclark', avatar: 'AC', color: 'bg-emerald-500', type: 'personal' },
    { id: 15, name: 'Amelia Lewis', handle: '@alewis', avatar: 'AL', color: 'bg-red-500', type: 'personal' },
    { id: 16, name: 'Daniel Walker', handle: '@dwalker', avatar: 'DW', color: 'bg-yellow-500', type: 'personal' },
    { id: 17, name: 'Harper Hall', handle: '@hhall', avatar: 'HH', color: 'bg-green-500', type: 'personal' },
    { id: 18, name: 'Matthew Allen', handle: '@mallen', avatar: 'MA', color: 'bg-blue-600', type: 'personal' },
    { id: 19, name: 'Evelyn Young', handle: '@eyoung', avatar: 'EY', color: 'bg-pink-600', type: 'personal' },
    { id: 20, name: 'Joseph King', handle: '@jking', avatar: 'JK', color: 'bg-purple-600', type: 'personal' },
  ], []);
  ...
  const handleNewRecipientClick = () => {
    setShowNewRecipientPopup(true);
  };

  const handleCloseNewRecipientPopup = () => {
    setShowNewRecipientPopup(false);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row pb-20 lg:pb-0">
          ...
          <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-center text-xs text-gray-400 mt-4">
                Need help? <button onClick={handleContactSupport} className="text-bank-primary hover:underline font-medium">Contact Support</button>
              </p>
            </div>
          </div>
        </div>
      ...
      {/* New Recipient Popup Overlay */}
      {showNewRecipientPopup && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="bg-gradient-to-br from-orange-500 to-red-500 p-6 sm:p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-white mb-1">Feature Unavailable</h2>
                <p className="text-orange-100 text-sm">New recipient addition is restricted</p>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-center text-xs text-gray-400 mt-4">
                Need help? <button onClick={() => { handleCloseNewRecipientPopup(); navigate('/support'); }} className="text-bank-primary hover:underline font-medium">Contact Support</button>
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="max-w-lg mx-auto space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <button 
                  ...
                  className="w-full p-4 flex items-center space-x-4 text-bank-primary hover:bg-blue-50 transition text-left border-t border-gray-100"
                >
